<template>
    <div>
        ...
        <div v-if="product" class="border">
            ...
            <p class="ms-2"><strong>가입 제한 : </strong> 
                <span v-if="product.join_deny === '1'">제한없음</span>
                <span v-if="product.join_deny === '2'">서민전용</span>
                <span v-if="product.join_deny === '3'">일부제한</span>
            </p>
            <p class="ms-2"><strong>공시 종료일 : </strong> 
                <span v-if="product.dcls_end_day">{{ product.dcls_end_day }}</span>
                <span v-else>미정</span>
            </p>
